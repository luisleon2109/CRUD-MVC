    ...
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Estudiantes != null ? 
                          ...
                          Problem("Entity set 'EstudiantesContext.Estudiantes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,ApellidoPaterno,ApellidoMaterno,Rol")] Estudiante estudiante)
        {
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,ApellidoPaterno,ApellidoMaterno,Rol")] Estudiante estudiante)
        {
            if (id != estudiante.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EstudiantesContext.Estudiantes'  is null.");
            }
            var estudiante = await _context.Estudiantes.FindAsync(id);
            if (estudiante != null)
            {
